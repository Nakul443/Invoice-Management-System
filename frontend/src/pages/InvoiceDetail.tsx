...
export default function InvoiceDetail() {
  ...
  const downloadPDF = async () => {
    const element = document.getElementById("invoice-content"); // The div we want to capture
    if (!element) return;
  ...
  <><div className="p-6">
      ...
      {/* This is the area that gets turned into a PDF */}
      <div id="invoice-content" className="bg-white p-8 border shadow-sm">
              ...
              <form onSubmit={handlePayment} className="space-y-8">
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    <span className="absolute left-6 top-1/2 -translate-y-1/2 text-xl font-bold text-slate-300 group-focus-within:text-indigo-500 transition-colors">
                      ₹
                    </span>
                    <input
                      type="number"
                ...
                <div className="flex gap-4">
                  ...
                  <button
                    ...
                    className="flex-1 py-4 bg-indigo-600 text-white font-bold rounded-2xl hover:bg-indigo-700 disabled:bg-slate-200 transition-all"
                  >
